...
<title>Login &mdash; Course Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Manage instructors and courses in one streamlined platform. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>Admin manages instructors</li>
            <li>Instructors manage courses</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="auth-foot">Don't have an account?
                <a href="index.php?page=register">Register as Instructor</a>
            </p>
